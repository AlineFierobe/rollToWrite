const homePage = {
  banner: {
    imageUrl:
      "https://images.unsplash.com/photo-1592819695396-064b9572a660?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    imageAlt: "Photo de Yannick Pulver sur Unsplash",
  },
  description: {
    title: "Bienvenue sur <span>Roll To Write</span>",
    icon: "pen-nib",
